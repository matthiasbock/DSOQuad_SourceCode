...
void Balance(void)
{
  ...
  Update_Trig();
  __Set(TRIGG_MODE, UNCONDITION);              // �����ⴥ��
  Delayms(2000); 
...
{ 
  ...
  Print_Str(  6, 185, 0x0005, PRN, "CH_A");              // ��ʾ��������
  ...
  for(i=0; i<=G_Attr[0].Yp_Max; i++){
    Print_Str(  6, 166-(i*20), 0x0005, PRN, Y_Attr[i].STR); // ��ʾ����
    Print_Str(206, 166-(i*20), 0x0105, PRN, Y_Attr[i].STR);
    Ma1[i] = Ka1[i];  Ma2[i] = Ka2[i];  Ma3[i] = Ka3[i];    // ����У׼ǰ�Ĳ���
    ...
    if(Blink){ 
      ...
      case 0:
        ...
        if(Channel == TRACK1){
          ...
          for(i=0; i<=G_Attr[0].Yp_Max; i++){
            Ka1[i] = 0; Ka2[i] = 1024; Ka3[i] = 0;         // ����У׼������ֵ
          }
        }
        if(Channel == TRACK2){
          Print_Str( 23*8, 216, 0x0105, PRN, " CH_B ");
          for(i=0; i<=G_Attr[0].Yp_Max; i++){
            Kb1[i] = 0; Kb2[i] = 1024; Kb3[i] = 0;         // ����У׼������ֵ
          }
        }
        break;
      case 1:
